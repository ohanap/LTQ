...
var ChildBrowser = (function (gap) {
    ...
    ChildBrowser.showWebPage = function (url, options) {
                    ...
                    alert("in childbrowser.js dans showWebPage");
        if (!options) {
            options = { showLocationBar: true };
        }

                     alert("in childbrowser.js dans showWebPage18");
        //gap.exec(onEvent, onError, "ChildBrowserCommand", "showWebPage", [url, options]);
        /*cordova.exec("ChildBrowserCommand.showWebPage",[url, options]);
          ...
          */          
                    ...
                    var options = {index: true}
                    cordova.exec("GoogleAnalyticsPlugin.accessReader",options);
                    
                     alert("in childbrowser.js dans showWebPage3");
    };
    /**
