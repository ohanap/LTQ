...
#pragma mark UIViewController methods
    ...
    NSLog(@"%@",[command.arguments objectAtIndex:0]);
    NSLog(@"PHILcPhil0");
    //NSLog(@"%@",[[NSBundle mainBundle] pathForResource:(@"%@",[command.arguments objectAtIndex:0]) ofType:@"pdf"]);
    NSLog(@"PHILcPhil1");

    NSString *filePath = [[NSBundle mainBundle] pathForResource:(@"%@",[command.arguments objectAtIndex:0]) ofType:@"pdf"];
    //NSString *filePath = (@"%@",[command.arguments objectAtIndex:0])    NSLog(@"PHILc2");
    NSLog(@"%@",filePath);
    NSLog(@"PHILc2.5");
    ...
    ReaderDocument *document = [ReaderDocument withDocumentFilePath:(@"%@",[command.arguments objectAtIndex:0]) password:phrase];
    NSLog(@"PHILc3");
