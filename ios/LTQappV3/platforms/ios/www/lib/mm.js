...
var MM = {
    ...
    addSite: function(e) {
        ...
        var siteurl = MM.config.defaultSite;
        ...
        if (MM.touchMoving) {
            ...
            if (MM.inNodeWK) {
                ...
                if (window.plugins.webintent) {
                    ...
                    MM.log('Open external file using window.open 1');
                    console.log("PHIL2:" + link.slice(0, -4));
                    //cordova.exec(null, null, 'CDVPDFViewer', 'showPDF',['CordovaBot']);
